...
------------
    ...
    │
    ├── setup.py               <- makes project pip installable (pip install -e .) so cifar10_deep can be imported
    ├── cifar10_deep    <- Source code for use in this project.
    │   ├── __init__.py        <- Makes cifar10_deep a Python module
    │   │
